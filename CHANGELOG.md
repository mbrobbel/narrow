...
## [0.17.0](https://github.com/mbrobbel/narrow/compare/narrow-v0.16.0...narrow-v0.17.0) - 2026-09-23
...
- seal supported traits explicitly ([#712](https://github.com/mbrobbel/narrow/pull/712))
- clippy complexity warning about unused lifetime ([#675](https://github.com/mbrobbel/narrow/pull/675))
...
- *(deps)* bump release-plz/action from 0.5.138 to 0.5.139 ([#733](https://github.com/mbrobbel/narrow/pull/733))
- *(deps)* bump codecov/codecov-action from 7.1.0 to 7.1.1 ([#729](https://github.com/mbrobbel/narrow/pull/729))
- *(deps)* bump release-plz/action from 0.5.137 to 0.5.138 ([#728](https://github.com/mbrobbel/narrow/pull/728))
- *(deps)* bump codecov/codecov-action from 7.0.0 to 7.1.0 ([#722](https://github.com/mbrobbel/narrow/pull/722))
- *(deps)* bump release-plz/action from 0.5.136 to 0.5.137 ([#719](https://github.com/mbrobbel/narrow/pull/719))
- *(deps)* bump release-plz/action from 0.5.134 to 0.5.136 ([#713](https://github.com/mbrobbel/narrow/pull/713))
- *(deps)* bump release-plz/action from 0.5.133 to 0.5.134 ([#709](https://github.com/mbrobbel/narrow/pull/709))
- *(deps)* bump taiki-e/install-action from 2.86.6 to 2.87.5 ([#698](https://github.com/mbrobbel/narrow/pull/698))
- *(deps)* bump release-plz/action from 0.5.131 to 0.5.132 ([#697](https://github.com/mbrobbel/narrow/pull/697))
- *(deps)* bump actions/deploy-pages from 5.0.0 to 5.0.1 ([#695](https://github.com/mbrobbel/narrow/pull/695))
- *(deps)* bump taiki-e/install-action from 2.86.5 to 2.86.6 ([#678](https://github.com/mbrobbel/narrow/pull/678))
- *(deps)* bump rust-overlay from `fd2ebb9` to `f60c1b5` ([#679](https://github.com/mbrobbel/narrow/pull/679))
- *(deps)* bump taiki-e/install-action from 2.86.3 to 2.86.5 ([#676](https://github.com/mbrobbel/narrow/pull/676))
- *(deps)* bump rust-overlay from `89abdfd` to `fd2ebb9` ([#677](https://github.com/mbrobbel/narrow/pull/677))
- *(deps)* bump nixpkgs from `7525d99` to `07e1d92` ([#674](https://github.com/mbrobbel/narrow/pull/674))
- *(deps)* bump rust-overlay from `471286a` to `b32685d` ([#673](https://github.com/mbrobbel/narrow/pull/673))
- *(deps)* bump mozilla-actions/sccache-action from 0.0.10 to 0.0.11 ([#636](https://github.com/mbrobbel/narrow/pull/636))
- *(deps)* bump taiki-e/install-action from 2.85.0 to 2.86.3 ([#672](https://github.com/mbrobbel/narrow/pull/672))
...
- *(deps)* bump syn from 2.0.108 to 2.0.109 ([#471](https://github.com/mbrobbel/narrow/pull/471))
- remove `clippy::string_to_string` (removed lint) ([#472](https://github.com/mbrobbel/narrow/pull/472))
...
- *(deps)* [**breaking**] bump the arrow group with 5 updates ([#462](https://github.com/mbrobbel/narrow/pull/462))
