...
//     type Item<'a> = bool;
//     type Array<const N: bool> = BooleanArray<N>;
// }
...
// {
//     type Item<'a> = Option<T::Item<'a>>;
//     type Array<const N: bool> = T::Array<true>;
// }

// fn a() {
//     let x: <Option<bool> as ArrayType>::Array<false>;
//     assert_eq!(x, true);
// }
...
//     type Array: Array; // + FromIterator<Self>; todo(mb): this causes issues with isize/usize
// }
...
// //     T: ArrayType,
// // {
// //     type Array = <T as ArrayType>::Array;
// // }
